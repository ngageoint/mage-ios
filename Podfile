...
target 'MAGE' do
    ...
    pod 'HexColors', '~> 2.2.1'
    pod 'GoogleSignIn'
    #pod 'mage-ios-sdk', :git => 'https://github.com/ngageoint/mage-ios-sdk.git', :tag=> '3.0.3'
    pod 'mage-ios-sdk', :git => 'https://github.com/ngageoint/mage-ios-sdk.git', :branch=> 'feed-display'
