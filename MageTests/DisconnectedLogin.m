...
//                NSLog(@"Auth Success");
//                NSUserDefaults *defaults = [NSUserDefaults standardUserDefaults];
//                XCTAssertTrue([@"offline" isEqualToString:[defaults valueForKey:@"loginType"]]);
//                XCTAssertTrue(authenticationStatus == AUTHENTICATION_SUCCESS);
//            }];
//        });
//        
...
//        });
//        
//        [loginDelegate loginWithParameters:parameters withAuthenticationStrategy:@"local" complete:^(AuthenticationStatus authenticationStatus, NSString *errorString) {
//            NSLog(@"Unable to authenticate");
//            XCTFail(@"Should not be in here");
//        }];
//        
