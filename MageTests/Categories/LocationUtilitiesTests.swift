...
class LocationUtilitiesTests: XCTestCase {
    
//    override func spec() {
        
//        describe("LocationUtilitiesTests Tests") {

    func testShouldDisplayTheCoordinate() {
//            it("should display the coordinate") {
    ...
    func testShouldSplitTheCoordinateString() {
//            it("should split the coordinate string") {
    ...
    func testShouldParseTheCoordinateString() {
//            it("should parse the coordinate string") {
    ...
    func testShouldParseTheCoordinateStringToADMSString() {
...
//            it("should parse to DMS 2") {
    ...
    func testShouldSplitTheCoordinateString2() {
//            it("should split the coordinate string") {
    ...
    func testShouldValidateDMSLatitudeInput() {
//            it("should validate DMS latitude input") {
    ...
    func testShouldReturnALatitudeDMSString() {
//            it("should return a latitude dms string") {
    ...
    func testShouldReturnALongitudeDMSString() {
