...
//    appearance.backgroundColor = colorScheme.primaryColor
//    
//    if let onPrimary = colorScheme.onPrimaryColor {
//        appearance.titleTextAttributes = [.foregroundColor: onPrimary]
//        appearance.largeTitleTextAttributes = [.foregroundColor: onPrimary]
//    }
//
//    UINavigationBar.appearance().standardAppearance = appearance
//    UINavigationBar.appearance().scrollEdgeAppearance = appearance
...
//    
//    if let onPrimary = colorScheme.onPrimaryColor {
//        docAppearance.titleTextAttributes = [.foregroundColor: onPrimary]
//        docAppearance.largeTitleTextAttributes = [.foregroundColor: onPrimary]
//    }
//
//    // UITabBar appearance
//    let tabAppearance = UITabBarAppearance()
...
//}
//
//private func setTabBarItemColors(_ itemAppearance: UITabBarItemAppearance, scheme: AppColorScheming) {
//    itemAppearance.normal.iconColor = scheme.onBackgroundColor.withAlphaComponent(0.6)
//    itemAppearance.normal.titleTextAttributes = [.foregroundColor: scheme.onBackgroundColor.withAlphaComponent(0.6)]
//
//    itemAppearance.selected.iconColor = scheme.primaryColorVariant.withAlphaComponent(0.87)
//    itemAppearance.selected.titleTextAttributes = [.foregroundColor: scheme.primaryColorVariant.withAlphaComponent(0.87)]
//}
//
