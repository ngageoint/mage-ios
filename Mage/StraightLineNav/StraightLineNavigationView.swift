...
//        speedLabel.font = scheme?.typographyScheme.overline
        distanceToTargetLabel.font = scheme?.typographyScheme.headline6Font
        relativeBearingToTargetLabel.font = scheme?.typographyScheme.headline6Font
    ...
    convenience init(locationManager: CLLocationManager?, destinationMarker: UIImage?, destinationCoordinate: CLLocationCoordinate2D, delegate: StraightLineNavigationDelegate?, scheme: AppContainerScheming? = nil, targetColor: UIColor = .systemGreen, bearingColor: UIColor = .systemRed) {
