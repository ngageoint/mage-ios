...
class BaseFieldView : UIView {
    ...
    func setPlaceholder(for textView: UITextView, from field: [String: Any]) {
        var placeholderText = field[FieldKey.title.key] as? String ?? ""
        ...
        textView.enablePlaceholderObservation()
    }
