...
struct IntroTabView: View {
    ...
    var body: some View {
        TabView {
            ...
            IntroView(title: "Join an Event", description: "Events are shared workspaces for a mission. All your observations are automatically saved and shared within your active Event.", imageName: "ExamplePhotoSix", isEndOfIntroViews: false)
                .padding()
                
            
            IntroView(title: "Add Details with Forms", description: "Use forms to enhance observations with photos, videos, notes, and audio.", imageName: "ExamplePhotoFive", isEndOfIntroViews: true)
