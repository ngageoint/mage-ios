...
@implementation TaskSessionManager

- (NSURLSessionDataTask *)GET_TASK:(NSString *)URLString
...
- (NSURLSessionDataTask *)HEAD_TASK:(NSString *)URLString
                    parameters:(id)parameters
...
- (NSURLSessionDataTask *)POST_TASK:(NSString *)URLString
                    parameters:(id)parameters
...
- (NSURLSessionDataTask *)PUT_TASK:(NSString *)URLString
                   parameters:(id)parameters
                      success:(void (^)(NSURLSessionDataTask *task, id responseObject))success
                      failure:(void (^)(NSURLSessionDataTask *task, NSError *error))failure
{
...
- (NSURLSessionDataTask *)PATCH_TASK:(NSString *)URLString
                     parameters:(id)parameters
                        success:(void (^)(NSURLSessionDataTask *task, id responseObject))success
                        failure:(void (^)(NSURLSessionDataTask *task, NSError *error))failure
{
...
- (NSURLSessionDataTask *)DELETE_TASK:(NSString *)URLString
                      parameters:(id)parameters
                         success:(void (^)(NSURLSessionDataTask *task, id responseObject))success
                         failure:(void (^)(NSURLSessionDataTask *task, NSError *error))failure
{
